...
const eventos = [
    { descricao: "Primeira lembrança...", imagem: "img/1.jpg" },
    { descricao: "Outra lembrança marcante", imagem: "img/2.jpg" },
    { descricao: "Evento memorável", imagem: "img/3.jpg" },
    { descricao: "Grande Acontecimento", imagem: "img/4.jpg" },
    { descricao: "Grande evento", imagem: "img/5.jpg" },
    { descricao: "Mais um grande momento...", imagem: "img/6.jpg" },
    { descricao: "Início de algo novo", imagem: "img/7.jpg" },
    { descricao: "Recordação", imagem: "img/8.jpg" },
    { descricao: "Ano de mudanças", imagem: "img/9.png" },
    { descricao: "Evento de 2009", imagem: "img/10.jpg" },
    { descricao: "Novo marco", imagem: "img/11.jpg" },
    { descricao: "Lembrança", imagem: "img/12.jpg" },
    { descricao: "Acontecimentos", imagem: "img/13.jpg" },
    { descricao: "Momentos", imagem: "img/14.jpg" },
    { descricao: "Recordações", imagem: "img/15.png" },
